...
train_annotation_dir = "/home/Chen_hongyu/ThreeStage_Model/ThreeStage_Model/RepLKNet_test/nodule_detection/yolov3/my_yolo_dataset_expand/train/labels"
val_annotation_dir = "/home/Chen_hongyu/ThreeStage_Model/ThreeStage_Model/RepLKNet_test/nodule_detection/yolov3/my_yolo_dataset_expand/val/labels"
classes_label = "./data_expand/my_data.data"
...
def main():
    ...
    train_txt_path = "data_expand/my_train_data.txt"
    val_txt_path = "data_expand/my_val_data.txt"
    ...
    create_data_data("./data_expand/my_data.data", classes_label, train_txt_path, val_txt_path, classes_info)
